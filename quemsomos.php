...
<head>
        <meta charset="utf-8">
		<title>SP SUBMERSO - Quem Somos</title>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Daniel Henrique</h5>
            ...
            <div class="col-md-3">
              <div class="card">
                <img src="img/escritorio1.jpg" class="card-img-top" alt="Imagem de Perfil 4">
                <div class="card-body">
                  <h5 class="card-title">Fabricio Souza</h5>
			...
			<div class="col-md-3">
              <div class="card">
                <img src="img/escritorio1.jpg" class="card-img-top" alt="Imagem de Perfil 4">
                <div class="card-body">
                  <h5 class="card-title">Felipe Bonelli</h5>
			...
			<div class="col-md-3">
              <div class="card">
                <img src="img/escritorio1.jpg" class="card-img-top" alt="Imagem de Perfil 4">
                <div class="card-body">
                  <h5 class="card-title">Leonardo Alves</h5>
